...
test('status of specified task should be changed', () => {
    const payload = {taskId: '2', todolistId: 'todolistId2', model: {status: TaskStatuses.New}}
    const action = updateTaskAC(payload);
...
test('title of specified task should be changed', () => {
    const payload = {taskId: '2', todolistId: 'todolistId2', model: {title: "yogurt"}}
    const action = updateTaskAC(payload);
...
test('tasks should be added for todolist', () => {
    ...
    const action = fetchTasksTC.fulfilled(params, "", "todolistId1");
